...
-- ── Testimonials (for landing page + admin QA) ──
insert into testimonials (author_name, author_city, author_role, content, rating, is_approved)
values
  ('أم عبدالله', 'الرياض', 'ولية أمر', 'ابني حفظ جزء عمه في شهرين فقط بفضل الله ثم بأكاديمية توبة. المعلم صبور جداً ومتخصص.', 5, true),
  ('محمد الغامدي', 'جدة', 'طالب', 'الدراسة مريحة جداً من البيت والمعلم يشرح بأسلوب سهل. أنصح به بشدة.', 5, true),
  ('فاطمة خالد', 'القاهرة', 'ولية أمر', 'بناتي يتعلمن مع معلمة متخصصة والجداول مرنة جداً تناسب مدرستهم.', 5, true),
  ('عبدالرحمن السيد', 'المنصورة', 'طالب', 'تعلمت أحكام التجويد من الصفر في ثلاثة أشهر. الأكاديمية ممتازة.', 4, true),
  ('أم يوسف', 'الكويت', 'ولية أمر', 'السعر مناسب جداً مقارنة بالجودة. معلمون محترفون وملتزمون بالمواعيد.', 5, true);
